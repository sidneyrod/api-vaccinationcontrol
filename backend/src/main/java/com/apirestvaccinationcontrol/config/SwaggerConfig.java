package com.apirestvaccinationcontrol.config;
...
public class SwaggerConfig {
	...
	@Bean
	public Docket vaccinationControlApi() {
	...
	private ApiInfo metaInfo() {
		ApiInfo apiInfo = new ApiInfo(
				"Vaccination Control API REST", 
				"API REST to control for vaccination control.", 
				"2.0",
				"Terms of Service",
