...
public class VaccinationControlResource {
	...
	@GetMapping
	public ResponseEntity<List<VaccinationControlDTO>> findAll() {
		List<VaccinationControlDTO> list = service.findAll();
		return ResponseEntity.ok().body(list);
	}
	
	@GetMapping(value = "/{id}")
	public ResponseEntity<VaccinationControlDTO> findById(@PathVariable Long id) {
		VaccinationControlDTO list = service.findById(id);
		return ResponseEntity.ok().body(list);
	}
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<VaccinationControlDTO> update(@PathVariable Long id, @Valid @RequestBody VaccinationControlDTO dto) {
