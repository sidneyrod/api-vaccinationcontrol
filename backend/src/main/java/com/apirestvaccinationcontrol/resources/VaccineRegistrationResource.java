...
public class VaccineRegistrationResource {
	...
	@PostMapping
	public ResponseEntity<VaccineRegistrationDTO> insert(@RequestBody VaccineRegistrationDTO dto) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<VaccineRegistrationDTO> update(@PathVariable Long id, @RequestBody VaccineRegistrationDTO dto) {
